...
public class MimeUtil {
	 ...
	 * The logger
	 */
	private static final Logger logger = Logger.getLogger(MimeUtil.class.getName());
	 ...
	 * 			The file name
	 * @return
	 * 			The mime type from our map, java's map or the standard mime type
	 */
	...
	public static void loadTypes() {
		...
		try {
			...
			for(Map.Entry<String, Object> entry : types.getChildren().entrySet()) {
